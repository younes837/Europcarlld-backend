    ...
    const result = await pool
      ...
      .query(`
        SELECT 
          ...
          PP.[F410QT],
          PP.[F410VISKM],
          CONVERT(VARCHAR, PP.[F400FACDT],   105) as [F400FACDT],
          PP.[F050NOM]
  ...
  try {
    ...
    const query = `
      SELECT 
        ...
        PC.F090LIB,
        F090KM,
        convert(varchar,F470DTDEP,  105) as F470DTDEP,
        convert(varchar,F470DTARRP,  105) as F470DTARRP,
        convert(varchar,F470DTARR,  105) as F470DTARR,
        F470DUREE,
        F470KMAFF,
        F470NBPNEUS,
