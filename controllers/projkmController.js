    ...
    const dataQuery = `
      WITH PaginatedData AS (
        SELECT
          ...
          CONVERT(VARCHAR, L.F470DTDEP,   105) AS DATE_DEPART,
          CONVERT(VARCHAR, L.F470DTARRP,   105) AS DATE_FIN,
    ...
    const query = `
      WITH PaginatedData AS (
        SELECT 
          ...
          CONVERT(VARCHAR, P.DD,   105) AS DATE_DEPART,
          CONVERT(VARCHAR, P.DF,   105) AS DATE_FIN,
          l.F410VISKM AS km_dernier_vidange, 
          CONVERT(VARCHAR, l.F410VISDT,   105) AS dernier_vidange, 
          CASE 
