...
//     const sortField = columnMapping[req.query.sortField] || "F080COMM.F080DTCOMM";
...
//       whereConditions.push(`[Fournisseur] LIKE '%${fournisseurSearch}%'`);
//     }
...
//             F080COMM.F080DTCOMM AS DateCommande,
...
const get_commande_encours = async (req, res) => {
  try {
    ...
    if (fournisseurSearch) {
      whereConditions.push(`F050TIERSFRS.F050NOM LIKE '%${fournisseurSearch}%'`);
    }
